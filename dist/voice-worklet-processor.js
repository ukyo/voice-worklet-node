class VoiceWorkletProcessor extends AudioWorkletProcessor {
    ...
    process(inputs, outputs) {
        ...
        if (this._states[2 /* INPUT_INDEX */] % 128 /* F0_ESTIMATION_BUFFER_LENGTH */ === 0) {
            Atomics.wake(this._states, 0 /* REQUEST_RENDER */, 1);
        }
        if (this._states[2 /* INPUT_INDEX */] >= 256 /* RING_BUFFER_LENGTH */) {
    ...
    _putInputChannelData(input) {
        ...
        const offset = (this._states[2 /* INPUT_INDEX */] % 256 /* RING_BUFFER_LENGTH */) * 128 /* FRAMES_PER_WORKLET_PROCESS */;
    ...
    _putOutputChannelData(output) {
        const offset = (this._states[3 /* OUTPUT_INDEX */] % 256 /* RING_BUFFER_LENGTH */) * 128 /* FRAMES_PER_WORKLET_PROCESS */;
